...
def ia(paddleB, time, Ball):
    if ball.velocity[0] >= 0 and ball.rect.centerx >= 700/2:
        if paddleB.rect.centery > ball.rect.centery:
            paddleB.moveUp(6)  
        if paddleB.rect.centery < ball.rect.centery:
            paddleB.moveDown(6)  
...
def win():
    ...
    if scoreA==3:
	    ...
	    font = pygame.font.Font(None, 36)
	    text3 = font.render("Computadora 2 Gana", 1, WHITE)
